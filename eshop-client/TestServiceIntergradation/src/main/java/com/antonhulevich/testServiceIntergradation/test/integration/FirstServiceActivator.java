...
import com.antonhulevich.testServiceIntergradation.test.domain.News;
...
public class FirstServiceActivator {
    ...
    //входящий канал(канал который принимает сообщения)
...
//    public MessageHandler productOut(){
...
//    }
    ...
    //еше один входящий канал(канал который принимает сообщения)
